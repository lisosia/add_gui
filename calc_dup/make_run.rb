...
\tcd $BASE_DIR/ && ruby -W0 #{path_check} $DIR >> check_results.log 2>> check_results.log # old format
\tcd $BASE_DIR/ && ruby #{path_check} --add $DIR --file check_results.json 2>> check_results.json.log
done
EOS
  else <<EOS
